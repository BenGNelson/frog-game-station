...
TESTS="routing.py frog_search.py frog_recent_search.py frog_settings.py frog_storage.py frog_touch.py frog_detail.py frog_meta.py frog_rematch.py frog_offline.py"
